...
export default function AdminFooterPage() {
  ...
  const loadFooterData = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/footer-settings/1`)
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await axios.put(`${import.meta.env.VITE_API_URL}/footer-settings/1`, updatedData)
